...
- **Avoid complex logic**: Keep logic within the test to a minimum. If complex setup or assertions are needed, consider moving them to helper functions.
- **Meaningful assertions**: Make assertions clear and direct. Avoid unnecessary or redundant assertions.

Make sure to always follow best practices for [describing elements](essentials/locating-elements) and [writing assertions](/essentials/crafting-assertions).
...
For more information, see [Test context](/essentials/test-context).
