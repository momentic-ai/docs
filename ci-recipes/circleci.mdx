...
The YAML example below assumes you have stored your [API key](/essentials/getting-an-api-key) as a secret named `MOMENTIC_API_KEY` in your [project settings](https://circleci.com/docs/env-vars/).
