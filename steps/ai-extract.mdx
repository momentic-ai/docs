...
The AI extract step allows you to pull textual information from the page in a structured format. You can then reference that information in later steps using [variables](/platform/test-context).
